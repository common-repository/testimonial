...
class class_testimonial_settings{
	...
	public function testimonial_menu_init() {
		...
		add_submenu_page('edit.php?post_type=testimonial', __('Settings','testimonial'), __('Settings','testimonial'), 'manage_options', 'testimonial_settings', array( $this, 'testimonial_settings' ));
